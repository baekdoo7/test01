...
function adopRun005(){
    ...
    if(typeof(pbjs) == "undefined" || typeof(pbjs.stopad02) == "undefined"){
        console.log("pbjs 객체가 없음");
        showAlladopAd01(false);

    }
    else{
        console.log("pbjs 객체가 있음 그래서 호출 " + pbjs.stopad02 );
...
var showAlladopAd01 = function(viewing){
    console.log("-------2222---------");
    console.log(showAlladopAd01.caller);
    console.log(viewing);
    if(viewing){
        return ;
    }
    ...
    console.log(adopHB);
    console.log(typeof(pbjs));
    console.log(typeof(pbjs.que2));
    if(typeof(pbjs) == "undefined" || typeof(pbjs.que2) == "undefined"){
        ...
        for(var areaId in adopHB.que){
            console.log(" ----- 영역 값 없네요!!! ----");
            console.log(areaId);
            console.log(typeof(pbjs.que2[areaId]));
            if(typeof(pbjs.que2[areaId]) == "undefined"){
                adopHBshow(areaId);
                console.log("adopHBshow 호출 ADOP 광고");
            }
            else{
                adopHBshow2(areaId);
                console.log("adopHBshow2 호출 헤더비딩 광고");
            }

        }
    }
    console.log("-------2222--------- 종료네요.");
}
