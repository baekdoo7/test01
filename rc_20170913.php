...
function passback_exec(url,width,height){
    ...
    var strIframe     = "<iframe id='"+strIframeId+"' frameborder='0' marginwidth='0' marginheight='0' paddingwidth='0' paddingheight='0' scrolling='no' style='width:"+width+"px; height:"+height+"px;' ></iframe>"; //속성추가할것
